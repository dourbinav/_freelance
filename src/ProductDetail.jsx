...
export const ProductDetail = () => {
  ...
  const productDetailUrl = `${window.location.origin}/productdetail/${product.id}/${category}`;

  const whatsappMessage = `I am interested in ${product.Name}. Check out the product details here: ${productDetailUrl}`;

  return (
    <div style={{ padding: "10px" }}>
      <Grid container style={{padding:"3px 0px 0px 10px"}}spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <Card style={{ height: "100%", padding: "10px" }}>
              <CardContent>
                ...
                >
                  Sizes: <Box style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '10px' }}>
                ...
                <Button
                  variant="contained"
                  color="success"
                  href={`https://wa.me/7466061836?text=${encodeURIComponent(whatsappMessage)}`}
                  target="_blank"
                  style={{
